...
void Pin_init(Pin *self, GPIO_TypeDef *puerto, int numeroDePin); //sin haber echo nada en test_gpio.c el compilador dira que no existe la funcion, eso es por que falta crearlo en pin_gpio.c
